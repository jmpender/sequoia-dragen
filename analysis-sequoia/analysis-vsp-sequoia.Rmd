...
df_influent_by.location_spike.removed_family                <- summarize_by_family_consolidated(df_influent_by.location_spike.removed)
df_influent_by.location_direct.compare_spike.removed_family <- summarize_by_family_consolidated(df_influent_by.location_direct.compare_spike.removed)
df_solids_by.location_spike.removed_family                  <- summarize_by_family_consolidated(df_solids_by.location_spike.removed)
df_solids_by.location_direct.compare_spike.removed_family   <- summarize_by_family_consolidated(df_solids_by.location_direct.compare_spike.removed)
...
summary_inf_all_wwtps      <- hpi.loc.summary(df_influent_by.location_spike.removed,
                                              df_influent_by.location_spike.removed_family, means_inf_select)
summary_inf_direct_compare <- hpi.loc.summary(df_influent_by.location_direct.compare_spike.removed,
                                              df_influent_by.location_direct.compare_spike.removed_family, means_inf_select)
summary_sol_all_wwtps      <- hpi.loc.summary(df_solids_by.location_spike.removed,
                                              df_solids_by.location_spike.removed_family, means_sol_select)
summary_sol_direct_compare <- hpi.loc.summary(df_solids_by.location_direct.compare_spike.removed,
                                              df_solids_by.location_direct.compare_spike.removed_family, means_sol_select)
...
# Create plots for total viruses present
pwalk(
  .l = list(
    df = plot_specs,
    subdir = names(plot_specs)
  ),
  .f = function(df, subdir) {
    outdir <- file.path("hpi_plots/1_total_viruses_present", subdir)
    dir.create(outdir, showWarnings = FALSE, recursive = TRUE)

    walk(names(hpi_labels), ~ ggsave(
      filename = file.path(outdir, paste0(.x, "_vs_total.viruses.present.pdf")),
      plot = hpi.plot(df = df, xval = .x, yval = "total.viruses.present"),
...
pwalk(
  ...
  .f = function(df, subdir) {
    outdir <- file.path("hpi_plots/2_vsp_targets", subdir)
    dir.create(outdir, showWarnings = FALSE, recursive = TRUE)

    walk(names(hpi_labels), ~ ggsave(
      filename = file.path(outdir, paste0(.x, "_vs_vsp.target.pdf")),
      plot = hpi.plot(df = df, xval = .x, yval = "VSP_Target"),
      width = 15, height = 13, units = "cm"
    ))
  }
)
...
pwalk(
  ...
  .f = function(df, subdir) {
    outdir <- file.path("hpi_plots/3_amr_untargeted", subdir)
    dir.create(outdir, showWarnings = FALSE, recursive = TRUE)

    walk(names(hpi_labels), ~ ggsave(
      filename = file.path(outdir, paste0(.x, "_vs_amr.pdf")),
      plot = hpi.plot(df = df, xval = .x, yval = "AMR"),
      width = 15, height = 13, units = "cm"
    ))
  }
)

# Create plots for total families
pwalk(
  .l = list(
    df = plot_specs,
    subdir = names(plot_specs)
  ...
  .f = function(df, subdir) {
    outdir <- file.path("hpi_plots/4_total_families_present", subdir)
    dir.create(outdir, showWarnings = FALSE, recursive = TRUE)

    walk(names(hpi_labels), ~ ggsave(
      filename = file.path(outdir, paste0(.x, "_vs_total.families.present.pdf")),
      plot = hpi.plot(df = df, xval = .x, yval = "total.vsp.families.present"),
      width = 15, height = 13, units = "cm"
    ))
  }
)
...
pwalk(
  ...
  .f = function(df, subdir) {
    outdir <- file.path("hpi_plots/5_total_high_risk_pandemic_families", subdir)
    dir.create(outdir, showWarnings = FALSE, recursive = TRUE)

    walk(names(hpi_labels), ~ ggsave(
      filename = file.path(outdir, paste0(.x, "_vs_high.pandemic.families.pdf")),
      plot = hpi.plot(df = df, xval = .x, yval = "high.pandemic.families"),
      width = 15, height = 13, units = "cm"
    ))
  }
)
...
pwalk(
  ...
  .f = function(df, subdir) {
    outdir <- file.path("hpi_plots/6_total_high_risk_epidemic_families", subdir)
    dir.create(outdir, showWarnings = FALSE, recursive = TRUE)

    walk(names(hpi_labels), ~ ggsave(
      filename = file.path(outdir, paste0(.x, "_vs_high.epidemic.families.pdf")),
      plot = hpi.plot(df = df, xval = .x, yval = "high.epidemic.families"),
      width = 15, height = 13, units = "cm"
    ))
  }
)
...
pwalk(
  ...
  .f = function(df, subdir) {
    outdir <- file.path("hpi_plots/7_total_high_risk_families_either", subdir)
    dir.create(outdir, showWarnings = FALSE, recursive = TRUE)

    walk(names(hpi_labels), ~ ggsave(
      filename = file.path(outdir, paste0(.x, "_vs_any.high.risk.families.pdf")),
      plot = hpi.plot(df = df, xval = .x, yval = "any.high.risk.families"),
      width = 15, height = 13, units = "cm"
    ))
  }
)
